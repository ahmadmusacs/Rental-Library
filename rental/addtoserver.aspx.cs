...
public partial class addtoserver : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        System.Collections.Specialized.NameValueCollection nvc = Request.Form;
        string name = "", password = "", email = "", roll = "";
        ...
        if (!string.IsNullOrEmpty(nvc["username"]))
        {
            ...
            con.Open();
            SqlCommand objcmd = new SqlCommand("Insert into datatable(Roll,Name,Email,Password) Values('" + roll + "','" + name + "','" + email + "','" + password + "')", con);
